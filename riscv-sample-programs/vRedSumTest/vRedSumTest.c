...
const int answerArray[19] = {8632, 354, 19781, 17901, 4232, 8260, 19296, 8814, 23004, 2660, 23793, 48600, 13260, 12485, 13699, 1896, 26270, 49815, 19019};
...
long main(long loop_count) {
  ...
  while(avl != 0) {
    ...
    asm volatile ("vredsum.vs v13, v12, v12");
